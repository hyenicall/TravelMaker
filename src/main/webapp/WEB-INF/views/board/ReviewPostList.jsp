				...
				<nav aria-label="Page navigation example">
				  <ul class="pagination">
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item">
									<a class="page-link" href="goReviewPostList?nowPage=${page.getStartPage() - 1}&to=${to}&searchType=${searchReviewPost.getSearchType()}&keyWord=${searchReviewPost.getKeyWord()}" aria-label="Previous">
										<span aria-hidden="true">&laquo;</span>
									</a>
								</li>
							</c:otherwise>
						...
						<c:forEach var="i" begin="${page.getStartPage()}" end="${page.getEndPage()}" step="1">
							<c:choose>
								...
								<c:otherwise>
									<li class="page-item">
										<a class="page-link" href="goReviewPostList?nowPage=${i}&to=${to}&searchType=${searchReviewPost.getSearchType()}&keyWord=${searchReviewPost.getKeyWord()}">${i}</a>
									</li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item">
									<a class="page-link" href="goReviewPostList?nowPage=${page.getEndPage() + 1}&to=${to}&searchType=${searchReviewPost.getSearchType()}&keyWord=${searchReviewPost.getKeyWord()}" aria-label="Next">
										<span aria-hidden="true">&raquo;</span>
									</a>
								</li>
							</c:otherwise>
